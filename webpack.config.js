...
Encore
    ...
    .addEntry('dashboard_list', './assets/js/dashboard/list.js')
	.addEntry('event_list', './assets/js/event/list.js')
	.addEntry('mevent_list', './assets/js/mevent/list.js')
