 ...
 */
final class Version20250303071702 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE activated activated TINYINT(1) DEFAULT 1');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE activated activated TINYINT(1) DEFAULT 1 NOT NULL');
    }
}
