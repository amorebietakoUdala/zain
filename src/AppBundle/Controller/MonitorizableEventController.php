...
use AppBundle\Forms\EventSearchForm;
use AppBundle\Forms\EventTryForm;
...
//	    dump($mevent,$event,$findSuccess, $findFailure);die;
	...
	foreach ( $mevents as $mevent ) {
	    ...
	    if ( $lastStatus == MonitorizableEvent::STATUS_SUCCESS ) {
	    ...
	    } elseif ( $lastStatus == MonitorizableEvent::STATUS_FAILURE ) {
	    ...
	    } elseif ( $lastStatus == MonitorizableEvent::STATUS_UNDEFINED ) {
